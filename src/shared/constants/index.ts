...
export const API_ENDPOINTS = {
  ...
  AI_ADMIN_SYNC: '/ai/admin/sync',
  AI_ADMIN_SYNC_STATUS: '/ai/admin/sync/status',
  AI_ADMIN_SYNC_PAUSE: '/ai/admin/sync/pause',
  AI_ADMIN_SYNC_RESUME: '/ai/admin/sync/resume',
} as const;
...
export const AI_ENDPOINTS = {
  ...
  ADMIN_SYNC: API_ENDPOINTS.AI_ADMIN_SYNC,
  ADMIN_SYNC_STATUS: API_ENDPOINTS.AI_ADMIN_SYNC_STATUS,
  ADMIN_SYNC_PAUSE: API_ENDPOINTS.AI_ADMIN_SYNC_PAUSE,
  ADMIN_SYNC_RESUME: API_ENDPOINTS.AI_ADMIN_SYNC_RESUME,
} as const;
